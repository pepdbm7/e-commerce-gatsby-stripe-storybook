...
import { StoryLinkWrapper } from '../src/components/StoryLinkWrapper';
...
// story of all the buttons types we want to create (estetics):
...
// buttonWrapper story (with functionality: onclick...):
...
//KNOBS (to instrument the props we want interactively in Storybook)
export const knobs = () => (
  <Button
    size={select('Size', ['small', 'medium'])}
    appearance={select('Appearance', ['primary', 'primaryOutline', 'secondary', 'secondaryOutline', 'tertiary', 'outline'])}
